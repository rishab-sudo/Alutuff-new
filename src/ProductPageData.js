    ...
    products: [
      {
        ...
        image: require('./assets/product-page/Corrugated Composite Panel 1.jpg'),
      },
          {
        id: 10,
        title: 'ACCP',
        description: 'Aluminium Corrugated Composite Panel',
        image: require('./assets/product-page/Corrugated Composite Panel 2 .jpg'),
      },
    ],
  },
    ...
    products: [
      {
        ...
        image: require('./assets/product-page/PREMIUM  1.jpg'),
      },
        {
        id: 16,
        title: 'Premium Series Panels',
        description: 'Luxurious gloss finish for high-end designs',
        image: require('./assets/product-page/PREMIUM 2.jpg'),
      },
    ],
  },
    {
